...
namespace SKGPortalCore.SeedDataInitial.SourceData
{
    public class ReceiptInfoMarketSPISeedData
    {
        ...
        /// 資訊流-超商產險
        /// </summary>
        public static List<ReceiptInfoBillMarketSPIModel> ReceiptInfoMarketSPIData(SysMessageLog Message)
        {
            ...
            if (err) { Message.AddCustErrorMessage(MessageCode.Code0000, "資訊流-超商產險Source拆分組合異常"); return null; }
