                ...
                List<BizCustomerSet> custs = new List<BizCustomerSet>()
                {
                    new BizCustomerSet() {
                        BizCustomer = new BizCustomerModel(){ CustomerCode="445235",CustomerId="48577921",AccountDeptId="0019",RealAccount="7714815486840", VirtualAccountLen= VirtualAccountLen.Len13,
                            ...
                            ChannelIds="00,01,02,03,04,05,12,13,14",CollectionTypeIds= LibData.Merge(",",false,ConstParameter.BankCollectionTypeId,ConstParameter.PostCollectionTypeId,"6V1,6V2,6V3"),AccountStatus= AccountStatus.Enable,ImportBatchNo="BeginData" },
                    ...
                    new BizCustomerSet() {
                        BizCustomer = new BizCustomerModel(){ CustomerCode="992086",CustomerId="30262944",AccountDeptId="0019",RealAccount="0514101002570", VirtualAccountLen= VirtualAccountLen.Len13,
                            ...
                            ChannelIds="00,01,02,03,04,05,12,13,14",CollectionTypeIds= LibData.Merge(",",false,ConstParameter.BankCollectionTypeId,ConstParameter.PostCollectionTypeId,"6V1,6V2,6V3"),BizCustType= BizCustType.Cust,AccountStatus= AccountStatus.Enable,ImportBatchNo="BeginData" },
                        BizCustomerFeeDetail =new List<BizCustomerFeeDetailModel>(){
