        ...
        public static void CreateChannel(SysMessageLog Message, ApplicationDbContext dataAccess)
        {
            try
            {
                ...
                List<ChannelSet> channels = new List<ChannelSet>() { new ChannelSet() { Channel = new ChannelModel(){ ChannelId="00", ChannelName="銀行臨櫃", ChannelGroupType= ChannelGroupType.Bank} },
                                                    ...
                                                    new ChannelSet() { Channel = new ChannelModel(){ ChannelId="A3", ChannelName="信用卡", ChannelGroupType= ChannelGroupType.Credit}},
                                                    new ChannelSet() { Channel = new ChannelModel(){ ChannelId="A4", ChannelName="ACH扣款", ChannelGroupType= ChannelGroupType.Credit}},
                                                    new ChannelSet() { Channel = new ChannelModel(){ ChannelId="A5", ChannelName="約定扣款(平台端)", ChannelGroupType= ChannelGroupType.Credit}},
                                                    };
