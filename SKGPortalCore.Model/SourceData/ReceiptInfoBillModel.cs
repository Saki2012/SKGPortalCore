...
namespace SKGPortalCore.Model.SourceData
{
    ...
    public class ReceiptInfoBillBankModel : IImportSource
    {
        ...
        public string RealAccount { get { return _RealAccount; } set { _RealAccount = value.PadLeft(13, '0').ByteSubString(0, 13); } }
        /// <summary>
        /// 2. 交易日期(8)
        /// </summary>
        [Description("交易日期"), MaxLength(8)]
        public string TradeDate { get { return _TradeDate; } set { _TradeDate = value.PadLeft(8, '0').ByteSubString(0, 8); } }
        /// <summary>
        /// 3. 交易時間(6)
        /// </summary>
        [Description("交易時間"), MaxLength(6)]
        public string TradeTime { get { return _TradeTime; } set { _TradeTime = value.PadLeft(6, '0').ByteSubString(0, 6); } }
        /// <summary>
        /// 4. 全方位銷帳編號(16)
        /// </summary>
        [Description("全方位銷帳編號"), MaxLength(16)]
        public string CompareCode { get { return _CompareCode; } set { _CompareCode = value.PadLeft(16, '0').ByteSubString(0, 16); } }
        /// <summary>
        /// 5. 金額符號±(1)
        /// </summary>
        [Description("金額符號±"), MaxLength(1)]
        public string PN { get { return _PN; } set { _PN = value.PadLeft(1, '0').ByteSubString(0, 1); } }
        /// <summary>
        /// 6. 交易金額(10)
        /// </summary>
        [Description("交易金額"), MaxLength(10)]
        public string Amount { get { return _Amount; } set { _Amount = value.PadLeft(10, '0').ByteSubString(0, 10); } }
        /// <summary>
        /// 7. 摘要(10)
        /// </summary>
        ...
        public string Branch { get { return _Branch; } set { _Branch = value.PadLeft(4, '0').ByteSubString(0, 4); } }
        /// <summary>
        /// 9. 交易通路(2)
        /// SA 存款; QA 支存; AG 約定扣繳;
        /// </summary>
        [Description("交易通路"), MaxLength(2)]
        public string TradeChannel { get { return _TradeChannel; } set { _TradeChannel = value.PadLeft(2, '0').ByteSubString(0, 2); } }
        /// <summary>
        /// 10. 超商代號(2)
        ...
        public string ChangeDate { get { return _ChangeDate; } set { _ChangeDate = value.PadLeft(8, '0').ByteSubString(0, 8); } }
        /// <summary>
        /// 12. 營業日(8)
        /// </summary>
        [Description("營業日"), MaxLength(8)]
        public string BizDate { get { return _BizDate; } set { _BizDate = value.PadLeft(8, '0').ByteSubString(0, 8); } }
        /// <summary>
        /// 13. 往來序號(6)
        /// </summary>
        [Description("往來序號"), MaxLength(6)]
        public string Serial { get { return _Serial; } set { _Serial = value.PadLeft(6, '0').ByteSubString(0, 6); } }
        /// <summary>
        /// 14. 全方位帳號(6)
        /// </summary>
        [Description("全方位帳號"), MaxLength(6)]
        public string CustomerCode { get { return _CustomerCode; } set { _CustomerCode = value.PadLeft(6, '0').ByteSubString(0, 6); } }
        /// <summary>
        /// 15. 手續費(3)
        /// </summary>
        ...
        public string Empty { get { return _Empty; } set { _Empty = value.PadLeft(25, '0').ByteSubString(0, 25); } }
        /// <summary>
        /// 導入批號
        /// </summary>
        [Description("導入批號")]
    ...
    public class ReceiptInfoBillMarketModel : IImportSource
    {
        ...
        public string Idx { get { return _Idx; } set { _Idx = value.PadLeft(1, '0').ByteSubString(0, 1); } }
        /// <summary>
        /// 2. 公司代號(8)
        /// </summary>
        [Description("公司代號"), MaxLength(8)]
        public string CollectionType { get { return _CollectionType; } set { _CollectionType = value.PadLeft(8, '0').ByteSubString(0, 8); } }
        /// <summary>
        /// 3. 代收機構代號(8)
        /// </summary>
        [Description("代收機構代號"), MaxLength(8)]
        public string Channel { get { return _Channel; } set { _Channel = value.PadLeft(8, '0').ByteSubString(0, 8); } }
        /// <summary>
        /// 4. 代收門市店號(8)
        /// </summary>
        [Description("代收門市店號"), MaxLength(8)]
        public string Store { get { return _Store; } set { _Store = value.PadLeft(8, '0').ByteSubString(0, 8); } }
        /// <summary>
        /// 5. 轉帳代繳帳號(14)
        /// </summary>
        [Description("轉帳代繳帳號"), MaxLength(14)]
        public string TransAccount { get { return _TransAccount; } set { _TransAccount = value.PadLeft(14, '0').ByteSubString(0, 14); } }
        /// <summary>
        /// 6. 轉帳類別(3)
        /// </summary>
        [Description("轉帳類別"), MaxLength(3)]
        public string TransType { get { return _TransType; } set { _TransType = value.PadLeft(3, '0').ByteSubString(0, 3); } }
        /// <summary>
        /// 7. 扣繳狀況(2)
        /// </summary>
        [Description("扣繳狀況"), MaxLength(2)]
        public string PayStatus { get { return _PayStatus; } set { _PayStatus = value.PadLeft(2, '0').ByteSubString(0, 2); } }
        /// <summary>
        /// 8. 門市會計日(8)
        /// </summary>
        [Description("門市會計日"), MaxLength(8)]
        public string AccountingDay { get { return _AccountingDay; } set { _AccountingDay = value.PadLeft(8, '0').ByteSubString(0, 8); } }
        /// <summary>
        /// 9. 顧客繳費日(8)
        /// </summary>
        [Description("顧客繳費日"), MaxLength(8)]
        public string PayDate { get { return _PayDate; } set { _PayDate = value.PadLeft(8, '0').ByteSubString(0, 8); } }
        /// <summary>
        /// 10. Barcode1(9)
        /// </summary>
        [Description("Barcode1"), MaxLength(9)]
        public string Barcode1 { get { return _Barcode1; } set { _Barcode1 = value.PadLeft(9, '0').ByteSubString(0, 9); } }
        /// <summary>
        /// 11. Barcode2(20)
        /// </summary>
        [Description("Barcode2"), MaxLength(20)]
        public string Barcode2 { get { return _Barcode2; } set { _Barcode2 = value.PadLeft(20, '0').ByteSubString(0, 20); } }
        /// <summary>
        /// 12. Barcode3(15)
        /// </summary>
        [Description("Barcode3"), MaxLength(15)]
        public string Barcode3 { get { return _Barcode3; } set { _Barcode3 = value.PadLeft(15, '0').ByteSubString(0, 15); } }
        /// <summary>
        /// 13. 保留(16)
        /// </summary>
        [Description("保留"), MaxLength(16)]
        public string Empty { get { return _Empty; } set { _Empty = value.PadLeft(16, '0').ByteSubString(0, 16); } }
        /// <summary>
        /// 導入批號
        /// </summary>
        [Description("導入批號")]
    ...
    public class ReceiptInfoBillMarketSPIModel : IImportSource
    {
        ...
        public string ISC { get { return _ISC; } set { _ISC = value.PadLeft(8, '0').ByteSubString(0, 8); } }
        /// <summary>
        /// 入/扣帳日期(8)
        /// </summary>
        [Description("入/扣帳日期"), MaxLength(8)]
        public string TransDate { get { return _TransDate; } set { _TransDate = value.PadLeft(8, '0').ByteSubString(0, 8); } }
        /// <summary>
        /// 繳費日期(8)
        /// </summary>
        ...
        public string Barcode2 { get { return _Barcode2; } set { _Barcode2 = value.PadLeft(16, '0').ByteSubString(0, 16); } }
        /// <summary>
        /// 應繳日期[Barcode3:1-4](4)
        /// </summary>
        [Description("應繳日期"), MaxLength(4)]
        public string Barcode3_Date { get { return _Barcode3_Date; } set { _Barcode3_Date = value.PadLeft(4, '0').ByteSubString(0, 4); } }
        /// <summary>
        /// 校對碼[Barcode3:5-6](2)
        /// </summary>
        [Description("校對碼"), MaxLength(2)]
        public string Barcode3_CompareCode { get { return _Barcode3_CompareCode; } set { _Barcode3_CompareCode = value.PadLeft(2, '0').ByteSubString(0, 2); } }
        /// <summary>
        /// 代收金額[Barcode3:5-6](9)
        /// </summary>
        [Description("代收金額"), MaxLength(9)]
        public string Barcode3_Amount { get { return _Barcode3_Amount; } set { _Barcode3_Amount = value.PadLeft(9, '0').ByteSubString(0, 9); } }
        /// <summary>
        /// 保留欄位1(18)
        /// </summary>
        ...
        public string Empty2 { get { return _Empty2; } set { _Empty2 = value.PadLeft(32, '0').ByteSubString(0, 32); } }
        /// <summary>
        /// 導入批號
        /// </summary>
        [Description("導入批號")]
    ...
    public class ReceiptInfoBillPostModel : IImportSource
    {
        ...
        public string TradeDate { get { return _TradeDate; } set { _TradeDate = value.PadLeft(7, '0').ByteSubString(0, 7); } }
        /// <summary>
        /// 3. 經辦局號(6)
        /// </summary>
        [Description("經辦局號"), MaxLength(6)]
        public string Branch { get { return _Branch; } set { _Branch = value.PadLeft(6, '0').ByteSubString(0, 6); } }
        /// <summary>
        /// 4. 交易代號(4)
        /// </summary>
        [Description("交易代號"), MaxLength(4)]
        public string Channel { get { return _Channel; } set { _Channel = value.PadLeft(4, '0').ByteSubString(0, 4); } }
        /// <summary>
        /// 5. 交易序號(7) 
        /// </summary>
        [Description("交易序號"), MaxLength(7)]
        public string TradeSer { get { return _TradeSer; } set { _TradeSer = value.PadLeft(7, '0').ByteSubString(0, 7); } }
        /// <summary>
        /// 6. 存提別(±)(1)
        /// </summary>
        ...
        public string CompareCode { get { return _CompareCode; } set { _CompareCode = value.PadLeft(24, '0').ByteSubString(0, 24); } }
        /// <summary>
        /// 9. 保留(42)
        /// </summary>
        [Description("保留"), MaxLength(42)]
        public string Empty { get { return _Empty; } set { _Empty = value.PadLeft(42, '0').ByteSubString(0, 42); } }
        /// <summary>
        /// 導入批號
        /// </summary>
        [Description("導入批號")]
