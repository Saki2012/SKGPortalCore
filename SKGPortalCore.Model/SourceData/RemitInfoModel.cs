...
namespace SKGPortalCore.Model.SourceData
{
    ...
    public class RemitInfoModel : IImportSource
    {
        ...
        public string RemitDate { get => _RemitDate; set => _RemitDate = value.PadLeft(8, '0').ByteSubString(0, 8); }
        /// <summary>
        /// 2. 匯款時間(6)
        /// </summary>
        [Description("交易日期"), MaxLength(6)]
        public string RemitTime { get => _RemitTime; set => _RemitTime = value.PadLeft(6, '0').ByteSubString(0, 6); }
        /// <summary>
        /// 3. 超商通路(2)
        /// </summary>
        ...
        public string CollectionType { get => _CollectionType; set => _CollectionType = value.PadLeft(3, '0').ByteSubString(0, 3); }
        /// <summary>
        /// 5. 交易金額(11)
        /// </summary>
        ...
        public string BatchNo { get => _BatchNo; set => _BatchNo = value.PadLeft(2, '0').ByteSubString(0, 2); }
        /// <summary>
        /// 7. 保留(96)
        /// </summary>
        [Description("保留"), MaxLength(96)]
        public string Empty { get => _Empty; set => _Empty = value.PadLeft(96, '0').ByteSubString(0, 96); }
        /// <summary>
        /// 導入批號
        /// </summary>
        [Description("導入批號")]
